...
class PDGServerConfig:
    ...
    def from_environment(cls) -> "PDGServerConfig":
        ...
        security = SecurityConfig(
            ...
            allowed_characters_pattern=os.getenv(
                "PDG_ALLOWED_CHARS_PATTERN", r"^[a-zA-Z0-9\-\+\*\(\)\[\]\{\}\.\,\s_/]*$"
            ),
        ...
        logging_config = LoggingConfig(
            ...
            format=os.getenv(
                "PDG_LOG_FORMAT", "%(asctime)s - %(name)s - %(levelname)s - %(message)s"
            ),
    ...
    def validate(self) -> bool:
        ...
        try:
            ...
            if (
                self.performance.pagination_max_limit
                < self.performance.pagination_default_limit
            ):
